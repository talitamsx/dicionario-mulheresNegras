function carregaDicionario() {
    ...
    for (let bio in miniBio) {
        content.innerHTML += 
        '<div class="cards">' + 
            '<img src="' + miniBio[bio].imagem + '"/>' + 
            "<details> <summary>" + 
                miniBio[bio].nome + "</summary>" + 
                "<p>" + miniBio[bio].descricao + "</p>" + "<blockquote> <q>" + miniBio[bio].citacao + "</q> </blockquote>" +
            "</details> </div>";

        // console.log(bio += " " + "Nome: " + miniBio[bio].nome + " " + "Minibio: " + miniBio[bio].descricao + " " + "Citação: " + miniBio[bio].citacao);
    }
}
carregaDicionario();
